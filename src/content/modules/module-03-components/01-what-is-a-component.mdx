...
Component គឺជា JavaScript function ដែល return ត្រឡប់មកវិញនូវ React element ដើម្បីកំណត់ថាតើអ្វីខ្លះត្រូវបង្ហាញនៅលើ screen។ Components ជួយប្រមូលផ្តុំ markup (JSX), logic និង styles ឱ្យស្ថិតនៅក្នុង module ឯករាជ្យតែមួយយ៉ាងមានសណ្តាប់ធ្នាប់។
